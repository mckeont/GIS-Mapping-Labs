...
1. **Install ArcGIS Pro on your computer**:
	...
	Sign-in using the Organization URL option: upenn.
	You will need to sign in with your Penn GIS account 
	To download and install the software: Click on your profile icon at the top right corner of the page. From the popup menu, click “my settings” -> then click “licenses” from the menu on the left. Scroll down to ArcGIS Pro in the listed items under the licensed products -> click download ArcGIS Pro. After installation, launching ArcGIS Pro will prompt you to sign into your ArcGIS online account for authorization. The organization’s URL is upenn.


2. **Access the university's computer**. If for some reason you cannot install ArcGIS on your own machine or if you would prefer to access remotely, go to  Connect to vLab Pool: https://computing.sas.upenn.edu/remote-teaching/vlab-connect
...
1.  Create a **workspace**, a project folder where you store your data files,
    ...
    done and save on your personal drive or cloud storage.
3.  Here we will acquire the following spatial data layers for the city
    ...
    institutions.
4.  Go to <http://www.pasda.psu.edu>. Under 'SEARCH BY KEYWORD(S)' enter
    'Philadelphia' and press submit.
5.  Find 2016 Philadelphia Planning - Schools, click on the link, press
    'Download', which will download a file.
6.  In addition to schools, find and download the following:
      - 2016 Philadelphia Streets - Bike Network
      - 2016 Philadelphia Planning - Neighborhoods
7.  You should have downloaded 3 files:
      - PhillyPlanning\_Schools.zip
      - PhillyPlanning\_Neighborhoods.zip
      - PhillyStreets\_Bike\_Network.zip
8.  Notice all 3 files are .zip files, which is a single file that is
...
9.  Unzip the archive. The lab computers have 7-Zip installed on them.
    In File Explorer, right-click the file and choose **7-Zip → Extract
    Here or 7-Zip → Extract to 'folder\_name'**.
10.  Unzip each of the .zip files using the 7-zip application (or another
...
8.  Click once on the neighborhoods layer (PhillyPlanning_Neighborhoods.shp) and click on the **Geography** tab at the top of the details pane on the right so
    ...
    neighborhoods.]([images/lab1_fig2.png](https://github.com/mckeont/GIS-Mapping-Labs/blob/main/images/philaNeighborhoods.png?raw=true))
